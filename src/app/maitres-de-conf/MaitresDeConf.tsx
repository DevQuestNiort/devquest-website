  ...
  return (
    <div className={styles.maitresDeConfContainer}>
      ...
      <Section theme="Dark">
        ...
        <p>
          Les Maîtres de Conf sont des bénévoles qui jouent le rôle
          d&apos;anges gardiens auprès des conférenciers tout au long de leur
          passage sur scène. Présents à leurs côtés de l&apos;introduction
          jusqu&apos;aux questions du public, ils veillent à ce que chaque talk
      ...
      <Section theme="Dark">
        ...
        <p>
          ...
          Découvrez celles et ceux qui accompagneront les speaker·euses lors du
          DevQuest 2026.
        </p>
      ...
      <Section theme="Light">
        <h2>💛 Merci à eux !</h2>
        <p>
          Un grand merci à tous nos Maîtres de Conf pour leur générosité et
          leur investissement. Grâce à eux, les conférenciers peuvent se
          concentrer sur l&apos;essentiel : partager leur savoir avec la
          communauté.
        </p>
      </Section>
    </div>
  ...
  return (
    ...
    >
      <Card theme="Light">
        ...
        <p>
          Les Maîtres de Conf sont des bénévoles passionnés qui accompagnent
          chaque conférencier·ère le jour J.
          <br /> Ils assurent une introduction chaleureuse, veillent au respect
          du timing et animent la session de questions en fin de talk.
        </p>
      </Card>
    </Section>
  );
